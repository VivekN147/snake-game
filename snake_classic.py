...
# Checks for errors established
check_errors = pygame.init()

if check_errors[1] > 0:
    print(
        f'[!] Had {check_errors[1]} errors when initialising game, terminating..')
    sys.exit(-1)
else:
...
while True:
    ...
    # Snake food spawning on the screen
    if not food_spawn:
